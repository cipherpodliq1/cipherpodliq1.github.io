...
### Задача: Игра на познаване на число

Описание:
Напиши програма, която кара потребителя да познае случайно число, генерирано от компютъра. Компютърът ще генерира число между 1 и 100, а потребителят ще има ограничен брой опити (например 7), за да го познае. Програмата ще използва while цикъл за продължаване на играта, докато не се познае числото или не свършат опитите, и for цикъл за обработка на множеството опити.

Стъпки:
Програмата генерира случайно число между 1 и 100.
Потребителят има 7 опита да познае числото.
Използвай while цикъл, който продължава играта, докато потребителят не познае числото или не свършат опитите.
За всеки опит използвай for цикъл, който кара потребителя да въвежда своето предположение и сравнява това число с генерираното.
Ако предположението е по-малко или по-голямо от целевото число, програмата да даде съвет на потребителя.
Ако потребителят познае числото, програмата приключва с поздравление.
Ако опитите свършат без успешно предположение, програмата показва правилното число.

### Кратки инструкции:
Генерирай случайно число между 1 и 100.
Позволи на потребителя 7 опита да го познае.
За всеки опит, ако числото е по-малко или по-голямо, дай съвет (например "по-голямо е" или "по-малко е").
Програмата приключва, когато потребителят познае числото или свършат опитите.
